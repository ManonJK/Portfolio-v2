...
<main>
    ...
    <div class="card-columns">
        <div class="card click" onclick="window.location.href='#';">
        ...
        <div class="card click">
            ...
            <div class="card-body">
                ...
                <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                <p class="card-text"><small class="text-muted">Le 02 janvier 2019</small></p>
            </div>
        </div>
    </div>
...
<!--                <h5 class="card-title">Info card title</h5>-->
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Mon stage chez gamned</li>
            <li class="list-group-item">Le chaos engineering chez Netflix</li>
